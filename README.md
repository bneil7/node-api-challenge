...
- [x] Mention two parts of Express that you learned about this week.
      //
      I learned that Express is like React for backend, in the sense that you can break up your code into compartmentalized components for reusability and predictability (this is done mostly with routing). I learned that in writing Middleware, you always need a `(req, res, next)` and the `next()` is what tells your program to move to the next action (based on the conditionality of the function of course). I learned that REST means Representational State Transfer, and we use Express to build RESTful web services that work with JSON data.
      //
- [x] Describe Middleware?
      //
      Middleware is created and used as a system of checks in your code, to make sure processes are running in a certain order based on proper authorization/validation.
      //
- [x] Describe a Resource?
      //
      A Resource is information (data) gathered from a database that we, as developers and users, use to call upon in our application to display/manipulate in our application.
      //
- [x] What can the API return to help clients know if a request was successful?
      //
      The API can return a status code between 200-299 to show that a request was successful. (200 = OK, 204 = no content, but OK/successful, etc.)
      //
- [x] How can we partition our application into sub-applications?
      //
      We partition our application into sub-applications by building specific routers for each different set of data we are trying to use.
      //
